...
const Homepage: React.FC<HomepageProps> = ({ onCreateAccount, onLogin }) => {
    ...
    <>
      <header>
          <div className="navbar-content">
                  ...
                  <img src="../../homepage/logotipo.png" alt="Logo SkillCode" className="logo" width="800" />
      ...
      <main className="container">
          ...
          <div className="botao-container">
            <button className="legendary-btn" onClick={onCreateAccount}>
                  <span className="btn-text">Comece aqui</span>
                  <span className="glow"></span>
                  <span className="particles"></span>
              </button>
              <button className="botaoentrar" onClick={onLogin}>Já tenho uma conta</button>
          </div>
      </main>
      <footer>
        <div className="footer-section">
            <h3>Sobre o SkillCode</h3>
            <p>Aprenda programação de forma <span>descomplicada</span> e <span>divertida</span>. Do zero ao código
                profissional!</p>
